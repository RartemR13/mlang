...
/**
 ** \file /home/iamnotexist/mlang/parser.hh
...
#ifndef YY_YY_HOME_IAMNOTEXIST_MLANG_PARSER_HH_INCLUDED
# define YY_YY_HOME_IAMNOTEXIST_MLANG_PARSER_HH_INCLUDED
...
#line 70 "/home/iamnotexist/mlang/parser.hh"
...
namespace yy {
#line 210 "/home/iamnotexist/mlang/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // condition
      char dummy2[sizeof (Condition*)];

      // exp
      char dummy3[sizeof (Expression*)];

      // if_statement
      char dummy4[sizeof (If*)];

      // print_statement
      char dummy5[sizeof (Print*)];
      ...
      // assignments
      char dummy7[sizeof (StatementList*)];
    ...
    TOK_GREATER = 272,             // ">"
    TOK_LOWER_OR_EQ = 273,         // "<="
    TOK_GREATER_OR_EQ = 274,       // ">="
    TOK_IDENTIFIER = 275,          // "identifier"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_main_function = 28,                    // main_function
        S_scope = 29,                            // scope
        S_assignments = 30,                      // assignments
        S_print_statement = 31,                  // print_statement
        S_if_statement = 32,                     // if_statement
        S_condition = 33,                        // condition
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_condition: // condition
        value.move< Condition* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_if_statement: // if_statement
        value.move< If* > (std::move (that.value));
        break;

      case symbol_kind::S_print_statement: // print_statement
        value.move< Print* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Condition*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, If*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const If*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Print*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Print*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_if_statement: // if_statement
        value.template destroy< If* > ();
        break;

      case symbol_kind::S_print_statement: // print_statement
        value.template destroy< Print* > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_END
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_GREATER_OR_EQ)
                   || (token::TOK_MAIN <= tok && tok <= token::TOK_ELSE));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LOWER_OR_EQ (location_type l)
      {
        return symbol_type (token::TOK_LOWER_OR_EQ, std::move (l));
      }
#else
      static
      symbol_type
      make_LOWER_OR_EQ (const location_type& l)
      {
        return symbol_type (token::TOK_LOWER_OR_EQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_GREATER_OR_EQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_GREATER_OR_EQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_condition: // condition
        value.copy< Condition* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_if_statement: // if_statement
        value.copy< If* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_print_statement: // print_statement
        value.copy< Print* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_condition: // condition
        value.move< Condition* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_if_statement: // if_statement
        value.move< If* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_print_statement: // print_statement
        value.move< Print* > (YY_MOVE (s.value));
        break;
...
#line 2021 "/home/iamnotexist/mlang/parser.hh"




#endif // !YY_YY_HOME_IAMNOTEXIST_MLANG_PARSER_HH_INCLUDED
